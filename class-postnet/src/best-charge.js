...
class BestCharge {
    ...
    formatBarcode({isTrueBarcode, barcode}, allCodes) {
    ...
    checkBarcodeCd({isTrueBarcode, barcode}, allCodes) {
        let trueBarcode = false;
        let codes = [];
        if (isTrueBarcode === true) {
    ...
    chageToBarcode({isTrueZipcode, zipcode}, allCodes) {
